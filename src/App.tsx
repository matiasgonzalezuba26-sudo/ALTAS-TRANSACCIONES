                        ...
                        <th className="py-3 px-4 text-center whitespace-nowrap">
                          <span className="flex items-center justify-center gap-1">
                            ...
                            <span className="relative group cursor-help">
                              ...
                              <span className="absolute left-1/2 -translate-x-1/2 top-full mt-2 right-0 w-96 bg-zinc-900 text-white text-[10px] font-normal normal-case tracking-normal rounded-lg px-3 py-2 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 leading-relaxed">
